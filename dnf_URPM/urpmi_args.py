...
def add_pkgselect_urpmi_args(parser):
    ...
    weakdeps_parser.add_argument("--allow-suggests", help="With this option, urpmi will install \"recommended\" packages. This is useful if install_weak_deps=False is set in dnf.conf", action="store_true", default=None)
